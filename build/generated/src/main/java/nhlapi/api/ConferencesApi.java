...
public class ConferencesApi {
   ...
   * @param id The ID of the conference. (required)
   * @return a {@code Conference}
   * @throws ApiException if fails to make API call
   */
  public Conference getConference(BigDecimal id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getConference");
    }
    
    // create path and map variables
    String localVarPath = "/conferences/{id}".replaceAll("\\{format\\}","json")
   ...
   * @return a {@code Conferences}
   * @throws ApiException if fails to make API call
   */
  public Conferences getConferences() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/conferences".replaceAll("\\{format\\}","json");
