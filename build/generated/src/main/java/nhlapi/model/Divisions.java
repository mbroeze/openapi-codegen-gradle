 ...
 */
@JsonPropertyOrder({
  Divisions.JSON_PROPERTY_COPYRIGHT,
  Divisions.JSON_PROPERTY_TEAMS
})
...
public class Divisions {
  ...
  private List<Division> teams = null;

  public Divisions() {
  }

  public Divisions copyright(String copyright) {
  ...
  **/
  ...
  public Divisions teams(List<Division> teams) {
    
    this.teams = teams;
    return this;
  }

  public Divisions addTeamsItem(Division teamsItem) {
    if (this.teams == null) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TEAMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTeams(List<Division> teams) {
    this.teams = teams;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.copyright, divisions.copyright) &&
        Objects.equals(this.teams, divisions.teams);
  }
